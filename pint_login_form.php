...
?>
	...
	<td class ="instruc" width="15%">&nbsp;</td>
      ...
      <ul style="padding-right:25px;text-align:justify;">
		<li style="font-family:arial; font-size:16px;text-align:justify;">
		<b>AVISO:</b> Use el Navegador <b>Mozilla Firefox</b>, de forma obligatoria para un mejor manejo del sistema .<br><br>
		</li>
