// JavaScript Document
	...
	function ciudades_p(estado,pais,ciudad)
	{
		//alert(pais);
		fajax('estados_ciudadesPlantel.php','capa_p','estado='+estado+'&pais='+pais+'&ciudad='+ciudad,'post','0');
	}
...
<!--SCRIPT QUE GENERA EL LISTADO DE LOS MUNICIPIOS CORRESPONDIENTE AL ESTADO SELECCIONADO-->
	...
	<!--FIN DEL SCRIPT--><!--SCRIPT QUE GENERA EL LISTADO DE LOS MUNICIPIOS CORRESPONDIENTE AL ESTADO SELECCIONADO-->	
