...
if ($pais == '232'){//SI EL PAIS ES VENEZUELA
	...
	if ($_POST['municipio'] != '' and is_numeric($codigo_mpio)){
		...
		$option = "<option value=\"".$codigo_mpio."\" selected> ".utf8_encode($nombre_mpio)." </option>";
...
<select name="codigom_S_1" id="codigom_S_1" onChange="parroquia_plantel(edo_plantel.value,this.value, hidden_parroq_plantel.value);">
