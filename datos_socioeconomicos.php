...
###########################################################################
		...
		$municipio=$_POST['municipio']; $municipio =strtoupper($municipio);//municipio de direccion de vivienda, nuevo
		$parroquia=$_POST['parroquia']; $parroquia =strtoupper($parroquia); //parroquia de direccion de vivienda, nuevo
		...
		$dir_p=$ciudad.".".$estado.".".$municipio.".".$parroquia.".".$avenida.".".$urbanizacion.".".$manzana.".".$edificio.".".$nrocasa;
		//////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$municipio_nac = $_POST['municipio_nac'];//el select de municipio de nac en el formulario
		$parroquia_nac = $_POST['parroquia_nac'];// el select de parroquia de nac en el formulario
		...
		$parroquia_plant = $_POST['parroquia_plant'];//select de parroquia de plantel en formulario
	...
	if ($filas_ACADEMICO == 1){
		...
		$sqlDOBE_A  = "UPDATE DOBE_ACADEMICO SET plantel='$nomb_plantel', tipo_plantel='$tipo_plantel', costo_mensual='$costo_mensual', codigo_p='$pais_plantel', codigo_e='$edo_plantel', codigo_c='$cd_plantel', codigo_m='$mpio_plantel', ano_egre_cole='$anio_egre_cole', sistema_estudio='$sistema_estudio', turno_estudio='$turno_estudio', titulo_b='$titulo_b', promedio='$promBachill', codigo_pquia='$parroquia_plant' WHERE exp_e='$exp_e' ";
		...
		///////////////////////////////////////////////////////////////////////////
		//$conex = new ODBC_Conn('dace9','sysadm','sysadm',TRUE,'pruebas.log');
		$sqlACADEMICO  = "INSERT INTO DOBE_ACADEMICO (exp_e, plantel, tipo_plantel, costo_mensual, codigo_p, codigo_e, codigo_c, codigo_m, ano_egre_cole, sistema_estudio, turno_estudio, titulo_b, promedio, codigo_pquia) VALUES ('$exp_e','$nomb_plantel', '$tipo_plantel', '$costo_mensual', '$pais_plantel', '$edo_plantel', '$cd_plantel', '$mpio_plantel', '$anio_egre_cole', '$sistema_estudio', '$turno_estudio', '$titulo_b', '$promBachill', '$parroquia_plant')";
		...
		///////////////////////////////////////////////////////////////////////////
		//$conex = new ODBC_Conn('dace9','sysadm','sysadm',TRUE,'pruebas.log');
		$sqlent  = "INSERT INTO DACE002 (exp_e, dirp_e, telfp_e, dirr_e, telfr_e, edo_c_e, etnia_indigena, res_extraj, doc_ident, pasaporte_nro, urbanizacion, avenida, manzana, nrocasa, telefono2, telefono3, correo1, correo2, ciudad, estado, ent_fed, p_nac_e, l_nac_e, ind_cnu, opcion_cnu, sexi, tot_hab_n, edo_nac_e, depend_p_e, tot_raz_v) VALUES ('$exp_e', '$dir_p', '$telfp_e', '$dir_r', '$telfr_e', '$edo_c_e','$etnia_indigena', '$res_extraj', '$doc_ident', '$pasaporte_nro', '$urbanizacion', '$avenida', '$manzana', '$nrocasa', '$telefono2', '$telefono3', '$correo1', '$correo2', '$ciudad', '$estado', '$edo_nac_e', '$pais_nac_e', '$ciudadN', '$promBachill', '$opcion_cnu', '$sexo', '$municipio', '$parroquia', '$municipio_nac', '$parroquia_nac')";
...
<tr>
	...
	<!-- aqui van los datos nuevos de direccion-->
